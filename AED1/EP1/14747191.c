...
int calcularPenalidade(TIME *time)
{
    // Completar
    {
        ...
        // CompletaralcularProblemasNaoResolvidos(MARATONA *mar)
        {
    ...
    // CompletararMaratona(MARATONA *mar, int numTimes)
    {
        if (!mar || numTimes < 1)
            return false;
        int x, p;
